      ...
      <div className="flex items-center gap-1 text-xs whitespace-nowrap">
        {items.length > 1 && (
          <button
            ...
            className={`flex items-center gap-1 px-2 py-1.5 rounded-xl transition-all ${theme.surfaceHover} ${theme.textMuted}`}
          >
            ...
            <button
              ...
              className={`flex items-center gap-1 px-2 py-1.5 rounded-xl transition-all ${
                index === items.length - 1
                  ? `${theme.accentLight} ${theme.accent} font-semibold`
